...
import { CheckCircle2, ShieldCheck, FileDown } from "lucide-react";
import { downloadInspectionPdf } from "@/lib/pdf/generate-inspection-pdf";
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      ...
      <div className="flex flex-wrap justify-end gap-3">
        ...
        <Button variant="outline" onClick={() => downloadInspectionPdf(inspection)}>
